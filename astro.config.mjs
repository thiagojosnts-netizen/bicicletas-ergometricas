...
export default defineConfig({
  ...
  redirects: {
    ...
    '/melhores-bicicletas-ergometricas/bicicleta-ergometrica-moviment/':  '/melhores-bicicletas-ergometricas/movement/',
    '/melhores-bicicletas-ergometricas/moviment/':                        '/melhores-bicicletas-ergometricas/movement/',
