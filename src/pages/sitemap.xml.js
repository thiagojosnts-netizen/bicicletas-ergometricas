export async function GET() {
  ...
  const urls = [
    ...
    { loc: "/como-usar", priority: "0.9" },
    // Comparativos
    { loc: "/comparativos", priority: "0.8" },
    { loc: "/comparativos/ergometrica-vs-spinning", priority: "0.8" },
    { loc: "/comparativos/mecanica-vs-magnetica", priority: "0.8" },
    { loc: "/comparativos/ergometrica-vs-esteira", priority: "0.8" },
    { loc: "/comparativos/ergometrica-vs-eliptico", priority: "0.8" },
    // Reviews por perfil
    ...
    { loc: "/reviews/manutencao-bicicleta-ergometrica", priority: "0.7" },
    // Ferramentas
    { loc: "/ferramentas/quiz-qual-ergometrica", priority: "0.9" },
    { loc: "/ferramentas/calculadora-calorias", priority: "0.7" },
  ];
  const items = urls.map(u =>
    "<url><loc>" + siteUrl + u.loc + "</loc><lastmod>" + now + "</lastmod><priority>" + u.priority + "</priority></url>"
  ).join("");
